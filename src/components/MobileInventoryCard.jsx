      ...
      <div className={`mic-card ${isCritical ? 'mic-critical' : ''}`}>
        ...
        <div className="mic-top" onClick={() => handlers.handleViewDetail?.(item)} style={{ cursor: 'pointer' }}>
          ...
          <div className="mic-info">
            ...
            {item.descripcion && <span style={{ fontSize: '0.75rem', opacity: 0.6, display: 'block', marginBottom: '4px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{item.descripcion}</span>}
